...
export function CityLinksGrid({
  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-surface border-t border-border">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 pb-3 border-b-4 border-primary">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {countryCities.map((city) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary/0 to-primary-2/0 group-hover:from-primary/10 group-hover:to-primary-2/10 transition-all duration-300" />

              {/* City Badge */}
              <div className="relative z-10">
                <div className="inline-block bg-primary/20 text-primary px-3 py-1 rounded-full text-xs font-semibold mb-3 group-hover:bg-primary/30 transition-colors">
                  City
                </div>
                ...
                {/* State/Region */}
                <p className="text-sm text-muted mb-4">{city.state}</p>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <p className="text-muted">Major Cities Covered</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary-2 mb-2">24/7</div>
              <p className="text-muted">Local Support Available</p>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-success mb-2">100%</div>
              <p className="text-muted">Local Market Coverage</p>
            </div>
          </div>
        </div>
      </div>
